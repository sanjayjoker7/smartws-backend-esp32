...
export default function Recyclable() {
  ...
  const [lastFillLevel, setLastFillLevel] = useState(recyclableBin?.fill_level || 0);
  ...
  useEffect(() => {
    if (recyclableBin) {
      ...
      if (lastFillLevel >= 80 && recyclableBin.fill_level < 30) {
        setFillCount(prev => Math.min(prev + 1, 4));
      }
      setLastFillLevel(recyclableBin.fill_level);
    }
  }, [recyclableBin?.fill_level, lastFillLevel]);
      ...
      <div className="glass-card p-8">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="relative w-32 h-44">
              <div className="absolute inset-0 rounded-2xl border-3 border-bin-recyclable/50 bg-gradient-to-b from-bin-recyclable/10 to-bin-recyclable/5 overflow-hidden">
                <div
                  ...
                  style={{ height: `${recyclableBin?.fill_level || 0}%` }}
                >
            ...
            <p className="mt-3 text-2xl font-display font-bold">{recyclableBin?.fill_level.toFixed(0)}%</p>
          </div>
      ...
      <div className="glass-card p-6">
        ...
        <div className="flex gap-2">
          {[1, 2, 3, 4].map((num) => (
            <div
              key={num}
              className={`flex-1 h-4 rounded-full transition-all duration-500 ${fillCount >= num
